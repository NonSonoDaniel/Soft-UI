!(function (a, b) {
    "function" == typeof define && define.amd
        ? define(["jquery", "fastsearch"], b)
        : "object" == typeof module && module.exports
        ? (module.exports = b(require("jquery"), require("fastsearch")))
        : b(a.jQuery)
})(this, function (a) {
    function b(a, b) {
    ...
    return (
        a.extend(b.prototype, {
            init: function (d, f) {
                ;(this.$input = a(d)),
                    ...
                    (this.optionsCollection = new c(
                        g({ multipleValues: this.isMultiple }, this.options, [
                            "url",
                            "loadOnce",
                            "parseData",
                            "matcher",
            ...
            setupDomElements: function () {
                ;(this.$el = a("<div>").addClass(this.options.elementClass)),
                    this[
                        this.isMultiple
            ...
            setupSingleElement: function (b) {
                ...
                this.$el.addClass(this.options.singleModeClass),
                    (this.$controls = a("<div>").addClass(
                        this.options.controlsClass
                    )),
                    (this.$toggleBtn = a("<div>")
                        .addClass(this.options.toggleButtonClass)
                        .text(d)
                        .appendTo(this.$el)),
                    (this.$queryInput = a("<input>")
            ...
            setupMultipleElement: function (b) {
                ...
                this.$el.addClass(d.multipleModeClass),
                    (this.$controls = a("<div>").addClass(d.controlsClass)),
                    (this.$queryInput = a("<input>")
                        .addClass(d.queryInputClass)
                        .appendTo(this.$controls)),
                    e &&
            ...
            setupFastsearch: function () {
                ...
                g(d, c, [
                    ...
                    (this.fastsearch = new f(
                        this.$queryInput.get(0),
                        a.extend(d, {
                            wrapSelector: this.isMultiple
                                ? this.$el
                                : this.$controls,
                            minQueryLength: 0,
                            typeTimeout: this.hasCustomLoader
                                ? c.typeTimeout
                                : 0,
                            preventSubmit: !0,
                            fillInputId: !1,
                            ...
                            onItemSelect: function (a, d, e) {
                                ...
                                b.isMultiple &&
                                f &&
                                b.optionsCollection.getValues().length > f - 1
                                    ? c.onMaxItemsReached &&
                                      c.onMaxItemsReached(this)
                                    : (b.setSelectedOption(d),
                                      b.writeToInput(),
                                      !b.isMultiple && b.hide(),
                                      c.clearQueryOnSelect && e.clear(),
                                      b.userOptionAllowed &&
                                          d.isUserOption &&
                                          (e.$resultsCont.remove(),
                                          delete e.$resultsCont,
                                          b.hide()),
                                      c.onItemSelect &&
                                          c.onItemSelect.call(b, a, d, b, e))
                            },
                            onItemCreate: function (a, d) {
                                ;(d.$item = a),
                                    d.selected &&
                                        a.addClass(c.itemSelectedClass),
                                    b.userOptionAllowed &&
                                        d.isUserOption &&
                                        a
                                            .text(
                                                b.options.userOptionPrefix +
                                                    a.text()
                                            )
                                            .addClass(
                                                b.options.userOptionClass
                                            ),
                                    c.onItemCreate &&
                                        c.onItemCreate.call(b, a, d, b)
                            },
                        })
                    )),
                    (this.fastsearch.getResults = function () {
                        b.userOptionAllowed &&
                            b.$queryInput.val().length > 1 &&
                            b.renderOptions(),
            ...
            getOptions: function (b) {
                ...
                if (this.hasCustomLoader) {
                    ...
                    e && c.apiParam && (d[c.apiParam] = e),
                        this.optionsCollection.fetch(d, b)
                } else
            ...
            setupEvents: function () {
                var b = this,
                    c = this.options
                this.isMultiple
                    ? (this.$el.on(this.namespaceEvents("click"), function (d) {
                          a(d.target).is(h(c.controlsClass)) &&
                              b.$queryInput.focus()
                      }),
                      this.$queryInput
                          .on(this.namespaceEvents("keyup"), function (a) {
                      ...
                      this.$el.on(
                          ...
                          h(c.choiceRemoveClass),
                          function (d) {
                              var e = a(d.currentTarget).closest(
                                  h(c.choiceItemClass)
                              )
                    ...
                    : this.$el.on(
                          this.namespaceEvents("click"),
                          h(c.toggleButtonClass),
                          function () {
                              b.$el.hasClass(c.activeClass)
                                  ? b.hide()
                                  : b.show(!0)
                          }
                      )
            ...
            setSelectedOption: function (a) {
                if (!this.optionsCollection.isSelected(a.value)) {
                    ...
                    this.isMultiple
                        ? this.$controls && this.addChoiceItem(a)
                        : (this.fastsearch &&
            ...
            removeSelectedOption: function (a, b) {
                ...
                c &&
                    c.$item &&
                    c.$item.removeClass(this.options.itemSelectedClass),
                    b
                        ? b.remove()
                        : this.$el
                              .find(
                                  h(this.options.choiceItemClass) +
                                      '[data-value="' +
                                      a.value +
                                      '"]'
                              )
            ...
            renderOptions: function (a) {
                var b,
                    c = this.$queryInput.val()
                if (
                    ((b = this.optionsCollection.models
                        ? (a
                              ? this.optionsCollection.filter(c)
                              : this.optionsCollection.models
                          ).slice(0)
                        : []),
                    this.userOptionAllowed)
                    ...
                    var d =
                        this.optionsCollection.models &&
                        this.optionsCollection.findWhere(function (a) {
                            return a.value === c
                        })
                    c &&
                        !d &&
                        b.unshift({ text: c, value: c, isUserOption: !0 })
                }
                this.fastsearch.showResults(
                    this.fastsearch.storeResponse(b).generateResults(b)
                )
            },
            gleanSelectData: function (b) {
                var c = this,
                    d = b.children()
                return d.eq(0).is("optgroup")
                    ? a.map(d.get(), function (b) {
                          var d = a(b)
                          return {
                              label: d.attr("label"),
        ...
        a.extend(c.prototype, {
            ...
            fetch: function (a, b) {
                ...
                this.options.loadOnce
                    ? ((this.fetchDeferred =
                          this.fetchDeferred || this.load(a)),
                      this.fetchDeferred.done(d))
                    : this.load(a, d)
            },
            reset: function (a) {
                ;(this.models = this.options.parseData
                    ? this.options.parseData(a)
                    : a),
                    this.applySelectedValues()
            },
            applySelectedValues: function (a) {
                this.each(function (a) {
                    this.options.multipleValues && a.selected
                        ? (this.selectedValues[a.value] = !0)
                        : (a.selected = !!this.selectedValues[a.value])
                }),
                    a && a.call(this)
            },
            load: function (b, c) {
                ...
                return a.get(e.url, b, function (a) {
                    ;(d.models = e.parseData ? e.parseData(a) : a),
                        c && c.call(d)
                })
            },
            setSelected: function (a) {
                this.options.multipleValues || (this.selectedValues = {}),
                    (this.selectedValues[a.value] = !0),
                    this.applySelectedValues()
            },
            removeSelected: function (a) {
                ...
                return (
                    b && (b.selected = !1),
                    delete this.selectedValues[a.value],
                    b
                )
            },
            ...
            each: function (b) {
                var c = this
                this.models &&
                    a.each(this.models, function (d, e) {
                        e.items
                            ? a.each(e.items, function (a, d) {
                                  b.call(c, d)
                              })
                            : b.call(c, e)
                    })
            ...
            filter: function (b) {
                ...
                var d = this
                return b && 0 !== b.length
                    ? a.map(this.models, function (b) {
                          if (b.items) {
                              var d = a.map(b.items, c)
                              return d.length
                                  ? { label: b.label, items: d }
                                  : null
                          }
                          return c(b)
                      })
        ...
        (b.defaults = {
            ...
            searchPlaceholder: "Cerca un'opzione",
            noResultsText: "Nessun risultato trovato",
            userOptionPrefix: "Aggiungi",
        }),
        (a.Fastselect = b),
        (a.Fastselect.OptionsCollection = c),
        (a.fn.fastselect = function (c) {
            return this.each(function () {
                a.data(this, "fastselect") ||
                    a.data(this, "fastselect", new b(this, c))
            })
        }),
        a
    )
