...
module.exports = function (config, themeConfig) {
    // loads only the menu without the other detail stuff
    config.guildSettingsMenu = async function (req, res, home, category) {
    ...
    // loads everything every time --> Extremely long website loading time
